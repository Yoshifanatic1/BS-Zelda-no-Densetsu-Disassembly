...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the BSZ1_InsertIntegratedPatches and BSZ1_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro BSZ1_InsertIntegratedPatches()
...
macro BSZ1_ApplyPatchesPostAssembly()
...
macro BSZ1_HandleDefaultPatches()
...
if !Define_Global_ROMToAssemble&(!ROM_BSZ1_OM1W3) != $00
	db $91,$E6,$82,$52,$98,$62
else
	db $91,$E6,$82,$51,$98,$62
endif
endmacro
